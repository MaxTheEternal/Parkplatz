...
const int ParkplatzToLed[30] = {
  0, 11, 1, 12, 2, 13, 3, 14, 4, 15, 22, 33, 21, 32, 20, 31, 19, 30, 18, 29, 36, 46, 37, 47, 38, 48, 39, 49, 40, 50
};

const int SensorToParkplatz[40] = {
  1, -1, 0, 2, 12, 10, -1, 3, 4, 6,
  8, -1, 9, 7, -1, 5, 14, 16, 18, -1,
  15, 13, 11, -1, -1, -1, 17, 19, 25, -1,
  21, 20, 28, 26, 24, 22, 27, -1, 29, 23
};
